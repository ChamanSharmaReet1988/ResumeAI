  ...
  Widget build(BuildContext context) {
    ...
    final preview = switch (item.previewKind) {
      ...
      _TemplatePreviewKind.profileSidebarResume =>
        _ProfileSidebarTemplateArtCompact(
      ...
      _TemplatePreviewKind.timelineProfileResume => _ResumeTemplatePreviewArt(
        resume: _applyTemplatePreviewPalette(
          // Grid tile keeps one project; the detail screen shows both.
          _timelineProfileTemplateResume.copyWith(
            projects: _timelineProfileTemplateResume.projects.take(1).toList(),
          ),
          paletteSeed,
        ),
      ),
...
class _TemplateArtDisplayScale extends InheritedWidget {
  const _TemplateArtDisplayScale({required this.scale, required super.child});
...
class _PremiumLockBadge extends StatelessWidget {
  const _PremiumLockBadge({required this.size});

  final double size;

  @override
  Widget build(BuildContext context) {
    return Icon(Icons.lock_rounded, size: size, color: const Color(0xFFC98910));
  }
}
...
final ResumeData _timelineProfileTemplateResume = ResumeData(
  ...
  summary:
      'Product marketing manager with nine years launching consumer and B2B software. Leads cross-functional launch teams, owns positioning and pricing research, and turns customer insight into campaigns that grow pipeline.',
  template: ResumeTemplate.timelineProfile,
  workExperiences: const [
    WorkExperience(
      role: 'Product Marketing Manager',
      company: 'Lumen Retail Systems',
      startDate: '2022',
      endDate: 'Present',
      description: '',
      bullets: [
        'Own positioning and launch plans for three product lines, lifting qualified pipeline 38% in two years.',
        'Run the quarterly launch calendar with product, sales and support leads.',
        'Built the competitive library and battlecards used by 60 sellers.',
      ],
    ),
    WorkExperience(
      role: 'Marketing Manager',
      company: 'Northwind Media Group',
      startDate: '2019',
      endDate: '2022',
      description: '',
      bullets: [
        'Rebuilt the demand programme, cutting cost per qualified lead by 24%.',
        'Led customer research that reshaped pricing for the self-serve plan.',
      ],
    ),
    WorkExperience(
      ...
      description: '',
      bullets: [
        'Ran content and email programmes for two regional product launches.',
      ],
    ),
  ],
  education: const [
    EducationItem(
      institution: 'Kingsley School of Business',
    ...
    EducationItem(
      institution: 'Ridgeway University',
  ...
  projects: const [
    ProjectItem(
      title: 'Self-Serve Plan Launch',
      subtitle: 'Lumen Retail Systems',
      bullets: [
        'Led pricing research and launch messaging that brought 1,200 self-serve signups in the first quarter.',
      ],
    ),
    ProjectItem(
      title: 'Competitive Intelligence Library',
      subtitle: 'Northwind Media Group',
      bullets: [
        'Built battlecards and win-loss reporting that lifted competitive win rate by 9 points.',
      ],
    ),
  ],
  customSections: const [
    ...
    CustomSectionItem(
      title: 'Reference',
      content:
          'Priya Raman\nLumen Retail Systems / VP Marketing\nPhone: +1 (415) 555-0188\nEmail: priya.raman@email.com',
    ),
  ],
  updatedAt: DateTime.fromMillisecondsSinceEpoch(0),
  githubLink: '',
...
final ResumeData _softHeaderTemplateResume = ResumeData(
  ...
  summary:
      'Operations manager with eight years running supply and service teams for food and logistics brands. Known for tightening processes, cutting cost per order and keeping service levels steady through peak seasons.',
  ...
  workExperiences: const [
    WorkExperience(
      ...
      description: '',
      bullets: [
        'Manage fulfilment for 14 sites and a team of 40, holding on-time delivery above 97%.',
        'Redesigned the replenishment process, lowering cost per order by 18%.',
      ],
    ),
    WorkExperience(
      role: 'Assistant Operations Manager',
      company: 'Carta Logistics',
      startDate: '2019',
      endDate: '2022',
      description: '',
      bullets: [
        'Introduced weekly capacity planning that cut overtime spend by 22%.',
        'Trained 30 staff on new warehouse safety and handling standards.',
      ],
    ),
    WorkExperience(
      role: 'Operations Coordinator',
      ...
      description: '',
      bullets: [
        'Tracked vendor performance and renegotiated three contracts, saving 11% a year.',
      ],
    ),
  ],
  education: const [
    ...
    EducationItem(
      institution: 'Riverton University',
      degree: 'Bachelor of Supply Chain Management',
      startDate: '2011',
      endDate: '2015',
      score: 'GPA: 3.7 / 4.0',
    ),
  ...
  projects: const [
    ProjectItem(
      title: 'Regional Fulfilment Redesign',
      subtitle: 'Brightline Foods',
      bullets: [
        'Reworked routing across 14 sites, holding on-time delivery at 97% through peak season.',
      ],
    ),
    ProjectItem(
      title: 'Vendor Scorecard Programme',
      subtitle: 'Carta Logistics',
      bullets: [
        'Introduced quarterly supplier scorecards that cut late deliveries by 26%.',
      ],
    ),
  ],
  customSections: const [
...
class _ProfileSidebarTemplateArtCompact extends StatelessWidget {
  ...
  static TextStyle _sectionHeadingStyle() =>
      ResumeTypography.garamondPreviewStyle(
                                  ...
                                  children: [
                                    ...
                                    if (projects.isNotEmpty) ...[
                                      ...
                                      for (final project in projects) ...[
                                        ...
                                        if (_templateArtProjectBullets(
                                          project,
                                        ).isNotEmpty) ...[
                                          const SizedBox(height: 2),
                                          _MiniBulletColumn(
                                            items: _templateArtProjectBullets(
                                              project,
                                            ).take(detailed ? 3 : 2).toList(),
                                            bulletColor: ResumeTypography
                                                .creativeBodyTextColor,
                                            textStyle: bodyStyle,
                                          ),
...
class _AtsSerifRulesTemplateArt extends StatelessWidget {
  ...
  TextStyle _garamond({required double fontSize, required int weight}) =>
      ResumeTypography.garamondPreviewStyle(
        weight: weight,
        fontSize: fontSize,
        color: ResumeTypography.atsStructuredBodyTextColor,
...
class _AtsModernFlowTemplateArt extends StatelessWidget {
  const _AtsModernFlowTemplateArt({required this.resume});
...
class _AtsExecutiveTemplateArt extends StatelessWidget {
  const _AtsExecutiveTemplateArt({required this.resume, this.detailed = false});
...
class _AtsProfessionalBlueTemplateArt extends StatelessWidget {
  ...
  TextStyle _garamondBody(
    ...
    fontSize: fontSize,
    color: color ?? ResumeTypography.atsStructuredBodyTextColor,
    height: height ?? ResumeTypography.atsProfessionalBlueBodyLineHeight,
  );
                ...
                child: DefaultTextStyle(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        height: _matchPreviewSpacing(
                          _ClassicSidebarPreviewSkillsSpacing
                              .beforeNextTitleGap,
                        ),
                      ),
                      Text(
...
class _MiniCoverLetterParagraph extends StatelessWidget {
  const _MiniCoverLetterParagraph({required this.text});
    ...
    return Row(
      ...
      children: [
        SizedBox(
          ...
          child: Align(
            alignment: Alignment.center,
            child: Icon(Icons.square, size: _squareSize, color: accentColor),
          ),
        ),
